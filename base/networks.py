...
class MLPNetwork(Network):
    ...
    def create_network(self):
        ...
        # self.network = models.Model(input_layer, output_layer, name=f"{self.task}_model")
    ...
    def build_with_tape(self, input, label, verbose):
        ...
        for epoch in range(self.epochs):
            ...
            if verbose == 1:
                ...
                pass
        self.metric_dict['loss'] = loss_per_epoch
        self.metric_dict[f'{evaluate_metric.name}'] = metric_per_epoch
